...
var PluginManager = function () {
  ...
  _createClass(PluginManager, [{
    ...
    value: function initializePlugins() {
      ...
      return _get__('Promise').all(initCalls);
    }
  }, {
    key: 'execute',
...
var _typeOfOriginalExport = typeof PluginManager === 'undefined' ? 'undefined' : _typeof(PluginManager);

function addNonEnumerableProperty(name, value) {
  Object.defineProperty(PluginManager, name, {
    value: value,
    enumerable: false,
    configurable: true
  });
...
if ((_typeOfOriginalExport === 'object' || _typeOfOriginalExport === 'function') && Object.isExtensible(PluginManager)) {
