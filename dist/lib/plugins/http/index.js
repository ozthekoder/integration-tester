...
var HttpPlugin = function (_Plugin) {
  ...
  _createClass(HttpPlugin, [{
    ...
    value: function get(endpoint) {
      ...
      return superagent.get('' + (0, _utility.createURL)(endpoint, this.config)).set(headers);
    }
  }, {
    key: 'post',
    value: function post(endpoint) {
      ...
      return superagent.post('' + (0, _utility.createURL)(endpoint, this.config)).set(headers).send(body);
    }
  }, {
    key: 'put',
    value: function put(endpoint) {
      ...
      return superagent.put('' + (0, _utility.createURL)(endpoint, this.config)).set(headers).send(body);
    }
  }, {
    key: 'delete',
    value: function _delete(endpoint) {
      ...
      return superagent.del('' + (0, _utility.createURL)(endpoint, this.config)).set(headers);
    }
  }]);
